...
def _normalise(value):
    """Make equal things look equal: 12.0 and 12 are the same car id."""
...
def notification_dedupe_key(driver_name: str, message: str, day: date) -> str:
    """The same message to the same driver on the same day is one notification."""
    return _sha256(canonical_json([driver_name, " ".join(message.split()), day.isoformat()]))
